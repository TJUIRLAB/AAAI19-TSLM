...
parser.add_argument('--dropouth', type=float, default=0.225,
...
parser.add_argument('--max_seq_len_delta', type=int, default=30,
...
if args.nhidlast < 0:
    args.nhidlast = args.emsize # 620
if args.dropoutl < 0:   # 0.29
    args.dropoutl = args.dropouth
if args.small_batch_size < 0:
    args.small_batch_size = args.batch_size # 12
